# The following code was originally written by github user dieghernan - a link
# blogpost explaining how to use it is included below:
...
# This code is included to shade in areas of Borneo that are not parts of Indonesia
# (but it does many more things than diagonal shading)
